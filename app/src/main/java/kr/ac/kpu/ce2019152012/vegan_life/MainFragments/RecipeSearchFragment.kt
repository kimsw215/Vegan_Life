...
import kr.ac.kpu.ce2019152012.vegan_life.Adapter.RecipeSearchAdapter
...
class RecipeSearchFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.searchRecipe.setOnQueryTextListener(searchViewTextListener)
    ...
    private fun setAdapter() {
        SearchAdapter = RecipeSearchAdapter(datas)
        SearchGManager =
            GridLayoutManager(requireContext(), HomeFragment.RawCount
        ...
        SearchAdapter.setOnItemClickListener(object : RecipeSearchAdapter.OnItemClickListener{
            override fun onItemClick(v: View, data: RecipeDataVo, post: Int) {
                val bundle = Bundle()
                bundle.putParcelable("item",data)
                view?.findNavController()?.navigate(R.id.action_recipeSearchFragment_to_recipeNextFragment,bundle)
                    .run {
                    }
            }
        })
    ...
    fun tempData(): ArrayList<RecipeDataVo> {
