...
class RecipeFragment : Fragment() , View.OnClickListener{
    ...
    val datas_k = mutableListOf<RecipeDataVo>()
    val datas_c = mutableListOf<RecipeDataVo>()
    val datas_j = mutableListOf<RecipeDataVo>()
    val datas_w = mutableListOf<RecipeDataVo>()
    val datas_d = mutableListOf<RecipeDataVo>()
    val datas_s = mutableListOf<RecipeDataVo>()
    ...
    override fun onClick(v: View?) {
        when(v?.id){
            ...
            binding.activeKoreanfood.id -> {
                ...
                if(binding.activeKoreanfood.isSelected) num = 2 else {
                    binding.activeAll.isSelected = true
                    num = 1
                }
            }
            ...
            binding.activeChinesefood.id -> {
                ...
                if(binding.activeChinesefood.isSelected) num = 3 else {
                    binding.activeAll.isSelected = true
                    num = 1
                }
            }
            ...
            binding.activeJapanesefood.id -> {
                ...
                if(binding.activeJapanesefood.isSelected) num = 4 else {
                    binding.activeAll.isSelected = true
                    num = 1
                }
            }
            ...
            binding.activeWesternfood.id -> {
                ...
                if(binding.activeWesternfood.isSelected) num = 5 else {
                    binding.activeAll.isSelected = true
                    num = 1
                }
            ...
            binding.activeDessert.id -> {
                ...
                if(binding.activeDessert.isSelected) num = 6 else {
                    binding.activeAll.isSelected = true
                    num = 1
                }
            }
            ...
            binding.activeSimplemeal.id -> {
                ...
                if(binding.activeSimplemeal.isSelected) num = 7 else {
                    binding.activeAll.isSelected = true
                    num = 1
                }
            }
